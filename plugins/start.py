...
async def start_command(client: Client, message: Message):
    ...
    if len(text)>7:
        ...
        k = await client.send_message(chat_id = message.from_user.id, text=f"ㅤㅤㅤ❕⌠  𝘐𝘔𝘗𝘖𝘙𝘛𝘈𝘕𝘛 ⌡ ❕\n\n◉ 「  𝘛𝘩𝘪𝘴 𝘷𝘪𝘥𝘦𝘰 / 𝘧𝘪𝘭𝘦 𝘸𝘪𝘭𝘭 𝘣𝘦 𝘥𝘦𝘭𝘦𝘵𝘦𝘥 𝘪𝘯 {file_auto_delete} 𝘮𝘪𝘯𝘶𝘵𝘦𝘴 (𝘋𝘶𝘦 𝘵𝘰 𝘤𝘰𝘱𝘺𝘳𝘪𝘨𝘩𝘵 𝘪𝘴𝘴𝘶𝘦𝘴  」\n\n◉ 「 𝘗𝘭𝘦𝘢𝘴𝘦 𝘧𝘰𝘳𝘸𝘢𝘳𝘥 𝘵𝘩𝘪𝘴 𝘷𝘪𝘥𝘦𝘰 / 𝘧𝘪𝘭𝘦 𝘵𝘰 𝘴𝘰𝘮𝘦𝘸𝘩𝘦𝘳𝘦 𝘦𝘭𝘴𝘦 𝘢𝘯𝘥 𝘴𝘵𝘢𝘳𝘵 𝘥𝘰𝘸𝘯𝘭𝘰𝘢𝘥𝘪𝘯𝘨 𝘵𝘩𝘦𝘳𝘦 」")
...
# Force Subscription Command (existing one)
...
async def not_joined(client: Client, message: Message):
    ...
    for i, channel_id in enumerate(force_sub_channels):
        try:
            ...
            print(f"PhdLust - Error generating invite link for channel {channel_id}: {e}")
    ...
    try:
        ...
        pass  # If there is no second command argument, just skip adding this button - PhdLust
    ...
    await message.reply_photo(
        ...
        quote=True,  # Quote the message to maintain context -PhdLust
        #disable_web_page_preview=True  # Disable web page preview if necessary - PhdLust
    )
